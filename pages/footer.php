                ...
                <div class="row">
                        ...
                        <div class="single-footer-widget marbtm50-s4">
                            <div class="our-info-box">
                                <div class="footer-logo">
                                    <a href="index-2.html">
                                          <img src="images/resources/wadelogo.png" alt="Awesome Logo">
                                    </a>
                                </div>
                                <div class="text">
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                        <div class="single-footer-widget s4">
                            <div class="title-style2">
                                <h3 style="color:#603913">Usefull Links</h3>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-3 col-md-12 col-sm-12">
                        <div class="single-footer-widget pdtop50-s4">
                            <div class="title-style2">
                                <h3  style="color:#603913">Subscribe Us</h3>
                            </div>
                            ...
                            <li>
                                <div class="single-footer-contact-info">
                                    <div class="inner">
                                        ...
                                        <div class="text">
                                            <p>+255 717 565 248<br> <span>Mon - Friday:</span> 9.00am to 6.00pm</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="single-footer-contact-info">
                                    <div class="inner">
                                        ...
                                        <div class="text">
                                          <p>waziriDello@gmail.com<br> aliwaziri@gmail.com</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="copyright-text text-center">
                            <p><a href="#" target="_blank" style="color:#ffffff">Abdulwahid Sadiq</a></p>
                        </div>
                    </div>
                </div>
            </div>
